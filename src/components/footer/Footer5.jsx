        ...
        <div className="col-lg-4 col-sm-6 d-flex">
          <div className="footer-widget">
            ...
            <div className="footer-contact mb-40">
              ...
              <a href="mailto:ifo@wcadlimited.com">info@wcadlimited.com</a><br />
          ...
          <div className="col-lg-12">
            <div className="footer-btn-content">
              <div className="copyright-area">
                <p>©Copyright 2023 <a href="#">wcadlimited</a> | Design By <a href="https://www.egenslab.com/">wcad Developers</a></p>
              </div>
