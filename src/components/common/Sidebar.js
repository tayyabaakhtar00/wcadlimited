      ...
      <div className="sidebar-menu-area">
        <ul className="menu-list">
          <li className="menu-item-has-children menu-item ">
            <a href="#" className="drop-down" data-hover="Home">Home</a>
          </li>
          <li className="menu-item"><Link legacyBehavior href="/about" data-hover="About"><a>About</a></Link></li>
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Service"><a>Service</a></Link>
          ...
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Project"><a>Project</a></Link>
          ...
          <li className="menu-item-has-children menu-item">
            <Link legacyBehavior href="/blog-grid" data-hover="Blog"><a>Blog</a></Link>
